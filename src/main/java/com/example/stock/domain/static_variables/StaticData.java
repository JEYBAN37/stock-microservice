...
public class StaticData {
    ...
    public static final String MESSAGE_ERROR_CATEGORY = "Category not found ";
    ...
    public static final String MESSAGE_ERROR_CATEGORY_CERO = "Category Not category valid ";
    ...
    public static final String MESSAGE_ERROR_CATEGORY_SIZE = "size invalid";

    public static final String NAME = "name";
    public static final String BRAND = "brand";
    public static final String ARTICLE_CATEGORY = "articleCategories";
